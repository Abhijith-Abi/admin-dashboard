...
export function ProductDetailsModal() {
  ...
  return (
    <Dialog open={!!selectedProduct} onOpenChange={(open) => !open && setSelectedProduct(null)}>
      <DialogContent className="sm:max-w-md bg-white/80 dark:bg-zinc-900/80 backdrop-blur-2xl border-zinc-200/50 dark:border-zinc-800/50 shadow-2xl rounded-3xl overflow-hidden">
        <DialogHeader className="pb-4 border-b border-zinc-200/50 dark:border-zinc-800/50">
          <DialogTitle className="text-2xl font-bold bg-linear-to-br from-zinc-900 to-zinc-500 dark:from-white dark:to-zinc-400 bg-clip-text text-transparent">
            Product Details
          </DialogTitle>
        </DialogHeader>
