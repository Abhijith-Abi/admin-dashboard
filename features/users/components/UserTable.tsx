    ...
    return (
        <div ref={containerRef} className="flex flex-col gap-5">
            {viewMode === "list" ? (
                ...
                >
                    {(isFetching || isPending) && allUsers.length > 0 && (
                    ...
                    <table className="w-full caption-bottom text-sm relative">
                        <TableHeader className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md shadow-sm sticky top-0 z-20">
                            <TableRow>
                                ...
                                <TableHead className="py-4 font-semibold text-zinc-900 dark:text-zinc-50 hidden md:table-cell">
                                    Phone
                                </TableHead>
