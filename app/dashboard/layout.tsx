...
export default function DashboardLayout({
    ...
    return (
        <div className="relative min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col overflow-hidden font-sans selection:bg-indigo-500/30">
            ...
            <div className="pt-6 px-4 sm:px-6 lg:px-8">
                <header className="sticky top-6 z-30 mx-auto max-w-7xl flex h-16 items-center gap-x-4 rounded-2xl border border-white/60 dark:border-white/10 bg-white/60 dark:bg-zinc-900/60 shadow-lg shadow-zinc-200/40 dark:shadow-black/40 backdrop-blur-xl px-6 transition-all duration-300">
